...
weights = [10, 5, 2, 8, 15,10,5,5, 10,34,23,12,15,8,4,15,7,10,14,2,5,20,45,23,12,5,13,24,6,9,3,20,2,6,4,15,21,13,12,14,13,15,16,5,14,19,5,9,6,4]
values = [1, 2, 3, 4, 5,5,5,4,6,9,12,1,5,6,14,6,8,1,4,5,7,7,8,3,7,3,7,6,9,12,4,6,3,3,3,3,8,6,9,3,2,3,6,8,3,5,7,1,12,6]
fitness = ml.Knapsack(weights, values, 0.6)
...
for n in range(5,50,8):
    ...
    s = time.time()
    best_state, best_fitness, fitness_curve = ml.random_hill_climb(problem, max_attempts=50, max_iters=1000,
                                                                   restarts=8,
                                                                    curve=True)
    e = time.time()
    t = e - s
    ...
    s1 = time.time()
    best_state1, best_fitness1, fitness_curve1 = ml.simulated_annealing(problem, schedule=schedule, max_attempts=20,
                                                                        max_iters=1000,
                                                                        curve=True)
    e1 = time.time()
    t1 = e1 - s1
    ...
    s2 = time.time()
    best_state2, best_fitness2, fitness_curve2 = ml.genetic_alg(problem, pop_size=160, mutation_prob=.3,
                                                                max_attempts=10, max_iters=1000, curve=True)
    e2 = time.time()
    t2 = e2 - s2
...
plt.figure()
plt.plot(np.arange(5,50,8),bs_0, label='rhc')
plt.plot(np.arange(5,50,8),bs_1, label='sa')
plt.plot(np.arange(5,50,8),bs_2, label='ga')
plt.plot(np.arange(5,50,8),bs_3, label='mimic')
plt.legend()
...
plt.figure()
plt.plot(np.arange(5,50,8),t_0, label='rhc')
plt.plot(np.arange(5,50,8),t_1, label='sa')
plt.plot(np.arange(5,50,8),t_2, label='ga')
plt.plot(np.arange(5,50,8),t_3, label='mimic')
plt.legend()
plt.xlabel('size of problem')
...
plt.figure()
plt.plot(np.arange(5,50,8),e_0, label='rhc')
plt.plot(np.arange(5,50,8),e_1, label='sa')
plt.plot(np.arange(5,50,8),e_2, label='ga')
plt.plot(np.arange(5,50,8),e_3, label='mimic')
plt.legend()
plt.xlabel('size of problem')
